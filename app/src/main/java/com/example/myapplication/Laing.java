...
public class Laing extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_laing);
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.main), (v, insets) -> {
            ...
            bottomNavigationView.setOnItemSelectedListener(item -> {
                if (item.getItemId() == R.id.navigation_home) {
                    startActivity(new Intent(Laing.this, MainActivity.class));
                    return true;
                } else if (item.getItemId() == R.id.navigation_recipes) {
                    startActivity(new Intent(Laing.this, Recipes.class));
                    return true;
                }
                return false;
            });
